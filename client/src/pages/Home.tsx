...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" data-testid="home-page">
      ...
      <section className="bg-gradient-to-br from-celtic-green-50 to-celtic-gold-50 bg-celtic-pattern" data-testid="welcome-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <h2 className="text-4xl md:text-5xl font-celtic font-bold text-celtic-green-600 mb-6" data-testid="text-welcome-title">
              Welcome back, {user?.firstName || 'Celtic Contributor'}!
            </h2>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto" data-testid="text-welcome-subtitle">
              {t('hero.subtitle')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                ...
                data-testid="button-welcome-contribute"
              >
              ...
              <Button
                ...
                data-testid="button-welcome-browse"
              >
